...
pub fn build_xy_rt(line: Vec<Vec<i32>>, bounds: Bounds) -> RTResult {
    let Bounds {
        x,
        y,
        z,
    ...
    for z in 0..line.len() {
        ...
        for line_index in 0..(layer_coords.len() / 3) as usize {
            ...
            for x_slice_layer in x_slice_begin_position..x_slice_end_position {
                ...
                result.y_rt[y_layer_index][(z as isize * x as isize + x_slice_layer) as usize] = 1;
                result.x_rt[x_layer_index][(z as isize * y as isize + *line_y as isize) as usize] =
                    1;
            }
            // result.x_rt
        }
